...
class AnimalFragment : Fragment() {
    ...
    private fun buildList() {
        ...
        while (t-- > 0) {
            val animal1 = Animal(
                "Tiger",
                "https://images.pexels.com/photos/145939/pexels-photo-145939.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260"
            )
            ...
            val animal = Animal(
                "Yak",
                "https://images.pexels.com/photos/144234/bull-landscape-nature-mammal-144234.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
            )
